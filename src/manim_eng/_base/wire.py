...
class Connection(Wire):
    def __init__(self, end_1: _Terminal, end_2: _Terminal, *args, **kwargs):
        ...
        #       reporting their positions - hopefully this will work once this is resolved.
        #       This also needs line culling to prevent unnecessary lines being drawn
        ...
        # TODO: pick whether to start with a horizontal or vertical line based on which is better aligned to the
