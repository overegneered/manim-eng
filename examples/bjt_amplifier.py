...
from manim_eng import VDD, Capacitor, Circuit, Earth, Node, NPNTransistor, Resistor


class BJTAmplifier(Scene):
    """A sample BJT amplifier circuit."""
    ...
    def construct(self) -> None:
        ...
        # TODO: the rotation of tripolar components are still problematic.
        # Try change their critical points.
        ...
        circuit = (
            Circuit(r1, r2, c, nodeinput, node1, bjt, rload, re, node2, node3, vdd, gnd)
